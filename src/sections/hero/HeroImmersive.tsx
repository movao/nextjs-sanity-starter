      ...
      <div className="container-narrow relative z-10 text-center">
        <div className="max-w-4xl mx-auto" data-animate="fade-up">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center animate-in animate-delay-2">
            <a href={ctaHref} className="btn-primary text-lg px-10 py-5">
              {ctaText}
            </a>
            <a
              href="#services"
              className="inline-flex items-center justify-center px-8 py-5 text-background/80 hover:text-background font-medium transition-colors"
            >
              Mehr erfahren
