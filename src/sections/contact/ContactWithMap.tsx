        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16" data-animate="fade-up">
          ...
          <div>
            <form action={formEndpoint} method="POST" className="space-y-5">
              ...
              <div>
                <label htmlFor="contact-map-name" className="block text-base font-medium text-foreground/80 mb-2">Name *</label>
              ...
              <div>
                <label htmlFor="contact-map-email" className="block text-base font-medium text-foreground/80 mb-2">E-Mail *</label>
              ...
              <div>
                <label htmlFor="contact-map-phone" className="block text-base font-medium text-foreground/80 mb-2">Telefon</label>
              ...
              <div>
                <label htmlFor="contact-map-message" className="block text-base font-medium text-foreground/80 mb-2">Nachricht *</label>
